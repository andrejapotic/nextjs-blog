...
export async function generateMetadata({ params }: PostIdRouteProps): Promise<Metadata> {
    ...
    if (!post) {
        return {
            title: "Post not found | Next.js Project",
            description: "The post you are looking for does not exist. Please check the URL and try again.",
        }
    }

    return {
        title: `${post.title} | Next.js Project`,
    ...
    return (
        <div className="max-w-3xl mx-auto py-8 px-4 animate-in fade-in duration-500 relative">
            ...
            <div className="relative w-full h-100 mb-8 rounded-xl overflow-hidden shadow-sm">
                <Image src={post.imageUrl ?? "https://images.unsplash.com/photo-1770110628704-86ba8c7b3b1c?q=80&w=654&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"} alt={post.title} fill className="object-cover hover:scale-105 transition-transform duration-500" />
            </div>
